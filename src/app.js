  ...
  res.ok({
    ...
    endpoints: {
      ...
      patients: {
        ...
        hospitalizations: 'GET /patients/:id/hospitalizations?limit=&offset=',
        appointments: 'GET /patients/:id/appointments?upcoming=true&limit=&offset=',
        attachments_list: 'GET /patients/:id/attachments?category=&limit=&offset=',
        attachment_upload: 'POST /patients/:id/attachments (multipart: file, category, label)',
